  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        {phase === 'LOBBY' ? (
          <Lobby onStart={startMatch} count={connectedCount} />
        ) : phase === 'MATCH_END' ? (
          <MatchEnd rows={leaderboard} meUid={uid} onReset={resetMatch} onStart={startMatch} />
        ) : phase === 'LEADERBOARD' ? (
      ...
      <Modal visible={refOpen} animationType="slide" onRequestClose={() => setRefOpen(false)}>
        <View style={styles.modal}>
          <Pressable style={styles.close} onPress={() => setRefOpen(false)}>
...
const styles = StyleSheet.create({
  ...
  modal: { flex: 1, backgroundColor: theme.bg, paddingHorizontal: 20, paddingTop: 20 },
  close: { alignSelf: 'flex-end', paddingVertical: 8, paddingHorizontal: 12 },
